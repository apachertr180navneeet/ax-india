...
<div class="container py-4">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h2 class="text-light"><i class="bi bi-cash-coin me-2 text-warning"></i>Creator Monetization Program</h2>
    ...
    <div class="card mb-4">
        <div class="card-header border-0 bg-transparent fw-bold">
            <h5 class="mb-0 text-light">Program Eligibility Overview</h5>
        </div>
        <div class="card-body">
            <div class="row g-4 text-center">
                <div class="col-md-3">
                    <div class="p-3 border rounded border-secondary">
                        ...
                        <span class="fw-bold text-light">{{ $isVerified ? 'Verified' : 'Not Verified' }}</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="p-3 border rounded border-secondary">
                        ...
                        <span class="fw-bold text-light">{{ number_format($subscribersCount) }} / 1,000</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="p-3 border rounded border-secondary">
                        ...
                        <span class="fw-bold text-light">{{ number_format($totalViews) }} / 40,000</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="p-3 border rounded border-secondary">
                        ...
                        <span class="fw-bold text-light">{{ $copyrightViolations }} Active</span>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-6">
            <div class="card h-100">
                <div class="card-header border-0 bg-transparent fw-bold">
                    <h5 class="mb-0 text-light">Earnings Summary</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card h-100">
                <div class="card-header border-0 bg-transparent fw-bold">
                    <h5 class="mb-0 text-light">Brand Collaborations</h5>
                </div>
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush bg-transparent">
                        @forelse($brandDeals as $deal)
                            <li class="list-group-item d-flex justify-content-between align-items-center py-3 border-secondary bg-transparent">
                                <div>
                                    <div class="fw-bold text-light">{{ $deal->campaign_title }}</div>
